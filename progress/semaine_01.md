...
Python (FastAPI / Flask) LLM (Open Source ou API) RAG (FAISS / ChromaDB) Fine-tuning du modèle sur des données de service client Base de données MySQL / PostgreSQL 
🔄 EN COURS Nous sommes en train de chercher des datasets appropie pour le projet.
